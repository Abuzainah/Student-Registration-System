<%@ page language="java" contentType="text/html; charset=windows-1256"
    ...
    <%@page import="com.abd.EnrollmentDAO"%>
     <%@page import="java.util.*"%>
 	 ...
 	 <%  ArrayList<Enrollment>absenceList=(ArrayList<Enrollment>)request.getAttribute("absence"); %> 
<!DOCTYPE html>
<html>
	<head>
		<meta charset="windows-1256">
		<title>Set Absence for student</title>
...
.hi2 {
	...
	<body>
	 ...
	 <h1>${Incomplete}</h1>
		 <div class="container">  
			  <form id="contact" action="SetAbsence" method="post">
				    ...
				    <fieldset>
				      <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Increase Absence</button>
				    </fieldset>    
			  </form>
		</div>
