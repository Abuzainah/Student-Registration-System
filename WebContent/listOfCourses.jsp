<%@ page language="java" contentType="text/html; charset=windows-1256"
    ...
    ArrayList<Enrollment>courseList=EnrollmentDAO.getStudentInstructorTeach(x);
    //ArrayList<Enrollment>courseList=(ArrayList<Enrollment>)(session.getAttribute("InstructorCourses"));
    %>    
