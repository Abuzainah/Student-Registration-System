...
<body>
	...
	<h3 class="title"> ${successMessage}</h3>
	<h3 class="title"> ${errorMessage}</h3>
	<div class="container">  
		  <form id="contact" action="AddStudent" method="post">
		    ...
		    <fieldset>
		      <input name="department" placeholder="Enter Department:" type="text" tabindex="5" required>
		    </fieldset>
		    <fieldset>
		      <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Create A Student</button>
		    </fieldset>
