<%@ page language="java" contentType="text/html; charset=windows-1256"
    ...
    <%@page import="com.abd.EnrollmentDAO"%>
     <%@page import="java.util.*"%>
 	 ...
 	 <%  ArrayList<Enrollment>gradeList=(ArrayList<Enrollment>)request.getAttribute("gradeList"); %>    
<!DOCTYPE html>
...
<body>
	<table class="table" id="customers" border="1">
			...
			<tr><th>Course ID</th><th>Course Name</th><th>Grades</th></tr>	
				
			<%
				for(Enrollment c: gradeList){			
			%>
			<tr>
				<td><%=c.getCourseId()%></td>
